ROOT_DIR="/nas/qianhao"

DS_CONFIG=./examples_deepspeed/finetune_hf_llama/ds_config.json
#DATASET_PATH=./alpaca_data.json
#DATASET_PATH=$ROOT_DIR/data/alpaca_data_en_52k.json
DATASET_PATH=$ROOT_DIR/data/sample_long_sft_32k_48M.json
# dataset link: https://github.com/tatsu-lab/stanford_alpaca/blob/main/alpaca_data.json

#HF_LLAMA_PATH=$ROOT_DIR/models/llama2-7b/
HF_LLAMA_PATH=$ROOT_DIR/models/Meta-Llama-3-70B
...
#MEGA_DS_LLAMA_PATH=$ROOT_DIR/models/"llama2-7b-mega-ds-B${MICRO_BATCH_SIZE}T${TP}P${PP}"
MEGA_DS_LLAMA_PATH=$ROOT_DIR/models/"llama3-70b-mega-ds-B${MICRO_BATCH_SIZE}T${TP}P${PP}"
...
covert_args="deepspeed --master_port 29501 tools/hf2megads_weight_converter.py \
--hf-ckpt-num-shards 30 \
